...
DEFAULT_MULTI_USER = (
    ...
    "Доступные категории:\n{categories}\n\n"
    "Инструкция:\n"
    "1. Прочитай текст. Есть ли в нем несколько разных смыслов?\n"
    "2. Если да — разбей на список элементов.\n"
    "3. Для каждого элемента укажи наиболее подходящую категорию из списка.\n"
    "4. Поле 'text' должно содержать чистую формулировку, очищенную от мусора других тем.\n\n"
    "ПРИМЕРЫ:\n"
